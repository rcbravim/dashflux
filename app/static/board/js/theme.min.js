    ...
    $(document).on('click', '.index_details, .index_edit, .index_del', function() {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                if (details || del) {
                    // entry information
                    $('.modal_entry_date span').text(data['entry']['date']);
                    ...
                    $('.modal_establishment_name span').text(data['establishment']['name']);

                    // category information
                    $('.modal_category_name span').text(data['category']['name']);
                    $('.modal_category_type span').text(data['category']['type']);
                    ...
                    $('.category_modal_edit option[value="'+data['category']['name']+'"]').prop('selected', true);
                    ...
                    $('.account_modal option[value="'+data['account']['name']+'"]').prop('selected', true);

                    let amount = data['entry']['amount'];
                    let type_transaction = amount < 0 ? 2 : 1;
                    $('.type_transaction_modal option[value="'+type_transaction+'"]').prop('selected', true);

                    amount = Math.abs(amount)
                    $('.amount_modal').val(formatCurrency(amount).replace('R$', ''));
