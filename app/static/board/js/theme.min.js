        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                if (details || del) {
                    ...
                    let cash;
                    if (data['financial_account']['bank'].toLowerCase() == 'cash') {
                        cash = true
                        $('.modal_cash span').text(data['financial_account']['bank']);
                        $('.bank_account_modal').addClass('d-none');
                        $('.cash_pay_modal').removeClass('d-none');
                    } else {
                        ...
                        $('.cash_pay_modal').addClass('d-none');
                    }

                    if (!isEmpty(data['financial_cost_center'])) {
                        if (cash) {
                            if ($('.modal_cash').hasClass('mb-2')) {
                                $('.modal_cash').removeClass('mb-2').addClass('mb-4');
                            }
                        } else {
                        ...
                        if (isEmpty(data['client'])) {
                            if (cash) {
                                $('.modal_cash').removeClass('mb-4').addClass('mb-2');
                            } else {
                    ...
                    $('.client_edit_modal option[value="'+data['client']['value']+'"]').prop('selected', true);

                    $('.cost_center_edit_modal option[value="'+data['financial_cost_center']['value']+'"]').prop('selected', true);
