...
$(document).ready(function(){
    ...
    // validation credit_card before edit
//    $("#edit_credit_card_form").submit(function(event) {
//        event.preventDefault();
//        let ccr_name_add = $('#ccr_name_add').val()
//        let ccr_name_edit = $('#ccr_name_edit').val()
//
//        if (ccr_name_add == '' && ccr_name_edit == '') { return }
//
//        let ccr_name = ccr_name_add != '' ? ccr_name_add : ccr_name_edit
//        let ccr_id = $('#edit_establishment').val()
//        let formData = {
//            'ccr_name': ccr_name,
//            'ccr_id': est_id,
//        }
...
//                        $('#ccr_name_edit').val(ccr_name_edit);
//                        $('#ccr_name_edit').addClass('is-invalid');
//                    } else {
//                        $('.valid_entry').nextAll('div:first').text('Estabelecimento já existe.');
//                        $('#ccr_name_add').val(ccr_name_add);
//                        $('#ccr_name_add').addClass('is-invalid');
//                    }
//                }
//                else {
//                    if (ccr_name_edit) {
